...
1. **Question 3.1** : Utiliser **Roboflow** pour créer un dataset, l'exporter au format ultralytics Hub, puis lancer l’apprentissage sur Roboflow. Tester les résultats. Comment récupérer et utiliser le réseau généré ?
2. **Question 3.2** : Sous **Ultralytics** Lancer l'entrainement sous google collab en utilisant le format **YOLOv5lu**. Tester les résultats et comparer avec ceux de Roboflow. Exporter ensuite au format **ONNX** et tester sous OpenCV.
